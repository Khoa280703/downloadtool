...
- Pillar 1: Money pages thắng intent cao
  - Homepage + 4 EN landing pages + các page support có CTA rõ
...
| 5 | Measurement, rollout, expansion gate | [phase-05-measurement-rollout-expansion-gate.md](./phase-05-measurement-rollout-expansion-gate.md) | deferred |
| 6 | Supporting content cluster | [phase-06-supporting-content-cluster.md](./phase-06-supporting-content-cluster.md) | complete |
| 7 | Authority, distribution, link acquisition | [phase-07-authority-distribution-link-acquisition.md](./phase-07-authority-distribution-link-acquisition.md) | deferred |
| 8 | SERP CTR optimization loop | [phase-08-serp-ctr-optimization-loop.md](./phase-08-serp-ctr-optimization-loop.md) | deferred |
