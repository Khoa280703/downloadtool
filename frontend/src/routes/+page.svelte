				...
				<form class="relative w-full max-w-[700px] mx-auto group mb-12" onsubmit={handleFetch}>
					...
					<div class="mt-6 flex flex-wrap justify-center gap-3 opacity-80 hover:opacity-100 transition-opacity">
						<div class="flex items-center gap-2 bg-white/60 px-3 py-1.5 rounded-xl border border-white/50">
							...
							<span class="font-bold text-xs text-plum/70">Ad-Free Forever</span>
						</div>
						<div class="flex items-center gap-2 bg-white/60 px-3 py-1.5 rounded-xl border border-white/50">
							<span class="material-symbols-outlined text-blue-500 text-lg">verified_user</span>
							<span class="font-bold text-xs text-plum/70">Safe &amp; Secure</span>
						</div>
						<div class="flex items-center gap-2 bg-white/60 px-3 py-1.5 rounded-xl border border-white/50">
							<span class="material-symbols-outlined text-purple-500 text-lg">rocket_launch</span>
							<span class="font-bold text-xs text-plum/70">Super Fast</span>
						</div>
					</div>
				</form>
			</div>
					...
					<div class="bg-white rounded-[2rem] shadow-card border border-indigo-50 overflow-hidden flex flex-col lg:flex-row">
						<div class="w-full lg:w-[42%] p-6 md:p-8 flex flex-col gap-5 bg-gradient-to-b from-indigo-50/50 to-white lg:border-r border-indigo-50">
							<div class="relative w-full aspect-video rounded-3xl overflow-hidden shadow-lg border-4 border-white bg-slate-100">
								...
								<div class="absolute bottom-4 right-4 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-full text-xs font-bold text-white border border-white/20">Available</div>
							</div>
							...
							{#if extractResult.description}
								<div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 text-sm text-slate-600 leading-relaxed">
									<span class="font-bold text-slate-800">Description:</span>
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
					<div class="relative group">
						<div class="bg-white p-6 rounded-[2rem] shadow-sm border border-pink-50 hover:shadow-float transition-all duration-300 h-full flex flex-col items-center text-center relative overflow-hidden">
							...
							<h3 class="text-xl font-bold text-plum mb-2">1. Find Video</h3>
							<p class="text-plum/60 text-sm font-medium leading-snug">Browse your favorite sites like YouTube or TikTok and copy the URL.</p>
						</div>
					...
					<div class="relative group md:-translate-y-4">
						<div class="step-paste-card bg-gradient-to-br from-white to-pink-50 p-6 rounded-[2rem] shadow-candy border border-pink-100 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center relative overflow-hidden z-10">
							...
							<h3 class="text-xl font-bold text-plum mb-2">2. Paste Link</h3>
							<p class="text-plum/60 text-sm font-medium leading-snug">Drop it into our mega input bar above. It glows when it's ready!</p>
						</div>
						<div class="md:hidden flex justify-center py-2 text-plum/20">
							<span class="material-symbols-outlined">arrow_downward</span>
						</div>
					...
					<div class="relative group">
						<div class="bg-white p-6 rounded-[2rem] shadow-sm border border-pink-50 hover:shadow-float transition-all duration-300 h-full flex flex-col items-center text-center relative overflow-hidden">
							...
							<h3 class="text-xl font-bold text-plum mb-2">3. Download</h3>
							<p class="text-plum/60 text-sm font-medium leading-snug">Click fetch and enjoy high quality video offline, anywhere.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="max-w-7xl mx-auto">
				<div class="mb-8">
					<div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
						<div class="text-left">
							<span class="text-xs font-bold text-primary uppercase tracking-wider mb-1 block">Power User Tools</span>
						...
						<p class="text-sm md:text-base text-plum/70 lg:max-w-[460px] lg:text-right leading-relaxed font-medium">
							We built shiny tools to make your life easier.
							<span class="inline-block whitespace-nowrap font-bold text-plum">Choose your fighter.</span>
						</p>
					</div>
				</div>
				<div class="grid grid-cols-1 lg:grid-cols-3 gap-5 items-stretch">
					<div class="bento-card group relative flex flex-col bg-white rounded-2xl p-5 border border-pink-50 shadow-sm overflow-hidden min-h-[300px]">
						<div class="absolute top-4 right-4 bg-secondary text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm z-10 tracking-widest uppercase">Recommended</div>
						<div class="flex-1 flex flex-col items-start z-10 mt-2">
							...
							<h3 class="text-lg font-bold text-plum mb-1">Chrome Extension</h3>
							<p class="text-plum/60 font-medium mb-4 text-sm leading-relaxed">Adds a cute "Fetch" button right under every video player.</p>
						</div>
					...
					<div class="bento-card group relative flex flex-col bg-white rounded-2xl p-1 border border-pink-100 shadow-sm min-h-[300px]">
						<div class="h-full flex flex-col p-4 bg-pink-50/30 rounded-xl backdrop-blur-sm">
							<div class="flex-1 flex flex-col items-start">
								...
								<h3 class="text-lg font-bold text-plum mb-1">Bookmarklet</h3>
								<p class="text-plum/60 font-medium mb-4 text-sm leading-relaxed">No install needed. Drag this pill to your bookmarks bar!</p>
					...
					<div class="bento-card group relative flex flex-col bg-plum rounded-2xl p-5 shadow-xl min-h-[300px] text-white overflow-hidden">
						...
						<div class="flex-1 flex flex-col items-start z-10 relative">
							...
							<h3 class="text-lg font-bold mb-1">Power User Script</h3>
							<p class="text-white/60 font-medium mb-4 text-sm leading-relaxed">For Tampermonkey users. Get raw control.</p>
			...
			<div class="max-w-7xl mx-auto relative z-10">
				<div class="flex flex-col md:flex-row items-center gap-8 mb-10">
					<div class="flex-1 text-center md:text-left">
						<span class="inline-block py-1 px-3 rounded-full bg-green-100 text-green-700 font-bold text-xs uppercase mb-3 tracking-wider">Trusted by 10,000+</span>
					...
					<div class="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div class="bg-white p-5 rounded-2xl shadow-sm border border-pink-50 hover:shadow-float hover:-translate-y-1 transition-all duration-300">
							...
							<p class="text-plum/70 font-medium italic text-xs leading-relaxed">"My grandma uses this! It's literally the only downloader she doesn't call me for help with."</p>
						</div>
						<div class="bg-white p-5 rounded-2xl shadow-sm border border-pink-50 hover:shadow-float hover:-translate-y-1 transition-all duration-300 sm:translate-y-4">
							...
							<p class="text-plum/70 font-medium italic text-xs leading-relaxed">"I save recipe videos for the kitchen where the WiFi doesn't reach. A literal lifesaver."</p>
						</div>
						<div class="col-span-1 sm:col-span-2 mt-2 bg-gradient-to-r from-primary/10 to-secondary/10 p-4 rounded-2xl border border-white/50 flex items-center justify-between">
							<div class="flex-1">
								<h4 class="font-bold text-plum text-sm mb-1">Join the party!</h4>
								<p class="text-plum/60 text-xs">Start downloading in seconds.</p>
							</div>
